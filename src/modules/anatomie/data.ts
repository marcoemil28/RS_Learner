...
export const ANATOMIE_THEMEN: AnatomieTopic[] = [
  {
    ...
    minLevel: 'SanH',
    summary: 'Aufbau des Herzens, Erregungsleitungssystem (Grundlage für das EKG-Modul) und die beiden Kreislaufsysteme.',
    sections: [
      {
        ...
        facts: [
          ...
          {
            text: '4 Herzklappen: Trikuspidalklappe (re. Vorhof/Kammer), Pulmonalklappe (re. Kammer/Lungenarterie), Mitralklappe (li. Vorhof/Kammer), Aortenklappe (li. Kammer/Aorta)',
            minLevel: 'RS',
          },
          {
      ...
      },
      {
        ...
        facts: [
          ...
          {
            text: 'AV-Knoten: verzögert die Erregung kurz (physiologische Bremse, entspricht der PQ-Zeit), sekundärer Schrittmacher mit Eigenfrequenz ~40–60/min, falls der Sinusknoten ausfällt',
            minLevel: 'RS',
          },
          {
            text: 'His-Bündel → rechter/linker Tawara-Schenkel → Purkinje-Fasern: schnelle Weiterleitung auf die Kammern → entspricht dem QRS-Komplex',
            minLevel: 'RS',
          },
          { text: 'Tertiäres Schrittmacherzentrum (Kammermyokard/Purkinje-Fasern): Eigenfrequenz nur ~20–40/min (Kammerersatzrhythmus)', minLevel: 'RS' },
          { text: 'Repolarisation der Kammern = T-Welle', minLevel: 'RS' },
        ],
      },
      {
        ...
        facts: [
          ...
          {
            text: 'Lungenkreislauf (kleiner Kreislauf): rechte Kammer → Lungenarterie → Lunge (Sauerstoffaufnahme) → Lungenvenen → linker Vorhof',
            minLevel: 'SanH',
          },
          {
    ...
    sections: [
      {
        ...
        facts: [
          { text: 'Nase/Mund → Rachen (Pharynx) → Kehlkopf (Larynx)', minLevel: 'SanH' },
          {
            text: 'Der Kehldeckel (Epiglottis) verschließt beim Schlucken den Kehlkopfeingang und schützt vor Aspiration (Verschlucken) in die Luftröhre',
            minLevel: 'SanH',
          },
        ],
      },
      ...
      },
      {
        ...
        facts: [
          ...
          { text: 'Ausatmung: in Ruhe meist passiv (elastischer Rückstoß der Lunge)', minLevel: 'RS' },
        ],
      },
      {
        heading: 'Atemregulation',
        facts: [
          {
            text: 'Das Atemzentrum im Hirnstamm steuert die Atmung überwiegend anhand des CO2-Partialdrucks im Blut',
            minLevel: 'RS',
          },
          {
    ...
    sections: [
      {
        ...
        facts: [
          ...
          {
            text: 'Brustkorb: Brustbein (Sternum: Manubrium, Corpus, Xiphoid) und 12 Rippenpaare (7 echte, 3 falsche, 2 frei endende)',
            minLevel: 'RS',
          },
        ],
      },
      {
        heading: 'Extremitätenskelett',
        facts: [
          { text: 'Obere Extremität: Schultergürtel, Oberarmknochen (Humerus), Unterarm (Speiche/Radius, Elle/Ulna), Hand', minLevel: 'SanH' },
          { text: 'Untere Extremität: Becken, Oberschenkelknochen (Femur, größter Röhrenknochen), Unterschenkel (Schienbein/Tibia, Wadenbein/Fibula), Fuß', minLevel: 'SanH' },
        ],
      },
      {
        heading: 'Gelenke',
        facts: [
          { text: 'Kugelgelenk (z. B. Schulter, Hüfte): Bewegung in alle Richtungen', minLevel: 'RS' },
          { text: 'Scharniergelenk (z. B. Ellenbogen, Knie): Beugung/Streckung in einer Ebene', minLevel: 'RS' },
        ],
      },
      {
        heading: 'Muskulatur',
  ...
  },
  {
    ...
    minLevel: 'SanH',
    summary:
      'Grobgliederung des Nervensystems, vegetatives Nervensystem (Grundlage für viele Medikamentenwirkungen) und Pupillenkontrolle.',
    sections: [
      {
      ...
      {
        heading: 'Vegetatives (autonomes) Nervensystem',
        facts: [
          {
            text: 'Sympathikus ("Kampf oder Flucht"): steigert Herzfrequenz und Blutdruck, erweitert die Bronchien, weitet die Pupillen',
            minLevel: 'RS',
          },
          {
            text: 'Parasympathikus ("Ruhe und Verdauung"): senkt die Herzfrequenz, fördert die Verdauung, verengt die Pupillen',
            minLevel: 'RS',
          },
          {
      ...
      {
        heading: 'Pupillenkontrolle',
        facts: [
          { text: 'Normalbefund: isokor (beide Seiten gleich groß), mittelweit, prompt lichtreagibel', minLevel: 'RS' },
    ...
    notes: ['Siehe auch Algorithmen: „Beurteilung der Bewusstseinslage (WASB & GCS)" für die strukturierte Bewusstseinsprüfung.'],
    sourceNote: GENERAL_SOURCE_NOTE,
  },
  {
    id: 'vitalparameter-normwerte',
    title: 'Vitalparameter-Normwerte nach Altersgruppe',
    ...
    sections: [
      {
        ...
        facts: [
          { text: 'Herzfrequenz: ca. 100–180/min (üblich eher 120–160/min)', minLevel: 'SanH' },
          { text: 'Atemfrequenz: ca. 30–60/min', minLevel: 'SanH' },
          { text: 'Blutdruck systolisch: ca. 60–90 mmHg', minLevel: 'RS' },
        ],
      },
      {
        heading: 'Säugling (1–12 Monate)',
        facts: [
          { text: 'Herzfrequenz: ca. 100–160/min', minLevel: 'SanH' },
          { text: 'Atemfrequenz: ca. 30–40/min', minLevel: 'SanH' },
          { text: 'Blutdruck systolisch: ca. 70–100 mmHg', minLevel: 'RS' },
        ],
      },
      {
        heading: 'Kleinkind (1–3 Jahre)',
        facts: [
          { text: 'Herzfrequenz: ca. 90–150/min', minLevel: 'SanH' },
          { text: 'Atemfrequenz: ca. 20–30/min', minLevel: 'SanH' },
          { text: 'Blutdruck systolisch: ca. 80–100 mmHg', minLevel: 'RS' },
        ],
      },
      {
        heading: 'Schulkind (6–12 Jahre)',
        facts: [
          { text: 'Herzfrequenz: ca. 70–120/min', minLevel: 'SanH' },
          { text: 'Atemfrequenz: ca. 16–24/min', minLevel: 'SanH' },
          { text: 'Blutdruck systolisch: ca. 90–110 mmHg', minLevel: 'RS' },
        ],
      },
      {
        heading: 'Jugendliche & Erwachsene',
        facts: [
          { text: 'Herzfrequenz: ca. 60–100/min', minLevel: 'SanH' },
          { text: 'Atemfrequenz: ca. 12–20/min', minLevel: 'SanH' },
          { text: 'Blutdruck systolisch: ca. 100–140 mmHg', minLevel: 'SanH' },
        ],
      },
      {
        heading: 'Für alle Altersgruppen',
        facts: [{ text: 'SpO2: normal ≥ 95 % (Zielbereiche im Einsatz siehe Medikamente: Sauerstoff)', minLevel: 'SanH' }],
      },
    ],
    notes: [
...
export function getAnatomieTopicById(id: string): AnatomieTopic | undefined {
  return ANATOMIE_THEMEN.find((t) => t.id === id);
}
