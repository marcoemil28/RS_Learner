...
export const GLOSSAR: GlossaryEntry[] = [
  { id: 'abcde', abbr: 'ABCDE', meaning: 'Airway, Breathing, Circulation, Disability, Exposure', description: 'Strukturiertes Schema zur Patientenbeurteilung — siehe Algorithmen-Modul.' },
  ...
  { id: 'sampler', abbr: 'SAMPLER', meaning: 'Symptome, Allergien, Medikamente, Patientenvorgeschichte, Letzte Mahlzeit, Ereignis, Risikofaktoren', description: 'Anamnese-Schema — siehe Algorithmen-Modul.' },
